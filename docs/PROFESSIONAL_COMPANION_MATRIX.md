...
| Follow, stop, resume, and reacquire a moving player | Implemented | Live follow and movement stop/resume slices | External clients, chunk unload, long-distance and 100-hour cases |
...
| Resource, inventory, and container accountability | Implemented for tested paths | Chest withdrawal, item pickup, crafting, smelting and equipment transactions | All workstation/container families and multi-session ownership cases |
