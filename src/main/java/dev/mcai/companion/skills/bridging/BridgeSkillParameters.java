...
final class BridgeSkillParameters {
    ...
    private BridgeSkillParameters() {
    }

    static SkillParameterResult<BridgeToParameters> parse(
        ...
        try {
            ...
            return SkillParameterResult.valid(new BridgeToParameters(
    ...
    private static SkillParameterResult<BridgeToParameters> invalid() {
        return SkillParameterResult.invalid(
                BridgeToSkill.NAME + ".invalid_arguments"
        );
    }
}
