...
| Simulated chunks/view distance | yes | moving-chunk fixture | NOT_RUN |
...
| Nether/portal/stronghold/End components | partial | bounded component fixtures; portal cast and End return inner-loop runs | NOT_RUN |
